...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/themes/js/managerHome.js"></script>
</head>
<body>
	...
	<div class="container">
			...
			<div class="col-md-6 col-md-offset-3 loginBox">
				...
				<form:form action="searchEmployee" modelAttribute="employee" method="POST">
					...
					<div class="form-group col-md-10 col-md-offset-1 gap">
						<a class="btn btn-warning form-control" href="registration">Add New Employee</a>
					</div>
				</form:form>
			</div>
	</div>
			     	...
			     	<c:if test="${not empty employeeList}">
			     		<c:forEach items="${employeeList}" var="item">
					      <tr>
				        	...
				        	<td><button class="btn btn-danger" id="deleteEmployee">Delete</button></td>
					      </tr>
				      </c:forEach>
			     	</c:if>
			    </tbody>
