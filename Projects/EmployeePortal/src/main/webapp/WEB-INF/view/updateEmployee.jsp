...
<body>
	...
	<div class="container">
		...
		<form:form action="updateEmployee" modelAttribute="TRAINING_EMPLOYEE" method="POST" class="registrationForm" id="updateForm">
			<div class="row col-md-offset-2">
				<div class="form-group col-md-5 gap">
					<label for="teamLabel">Employee ID</label>
					<form:input path="EMPLOYEE_ID" readonly="true" type="text" name="EMPLOYEE_ID" class="form-control" placeholder="Employee ID" id="EMPLOYEE_ID"/>
				</div>
				 <div class="form-group col-md-5 gap">
					<label for="teamLabel">Password</label>
					<form:input path="PASSWORD"  readonly="true"  type="password" name="PASSWORD" class="form-control" placeholder="Password" id="PASSWORD"/>
				</div>
				<div class="form-group col-md-5 gap">
				...
				<div class="form-group col-md-5 gap">
					...
					<form:input path="JOINED_AS" readonly="true" type="text"  name="JOINED_AS" class="form-control" placeholder="Joined As" id="JOINED_AS"/>
				</div>
			</div>
			<div class="row col-md-offset-2">
				<div class="form-group col-md-5 gap">
					<label for="teamLabel">Joined Date</label>
					<form:input path="JOINED_DATE" readonly="true"  type="date" name="JOINED_DATE" class="form-control" placeholder="Joined Date" id="JOINED_DATE"/>
				</div>
				<div class="form-group col-md-5 gap">
					<label for="teamLabel">Date Of Birth</label>
					<form:input path="DOB" readonly="true"  type="date" name="DOB" class="form-control" placeholder="Date Of Birth" id="DOB"/>
				</div>
				<div class="form-group col-md-5 gap">
